...
The main innovation brought by LamboDoge is its tax management. LamboDoge doens’t take a tax on each transaction but on each buy or sell,
...
- 50 billion tokens (50%) are splitted into 5 vault time locked. Each of them contains 10B tokens.
...
- 4 billion tokens (4%) were burned to the dead address `(0x000...Dead)`.
...
By allowing liquidity providers to stake their LP tokens into highly enough rewaring pools to counterbalance the risk of capital losses
