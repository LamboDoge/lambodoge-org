...
LegatoStake V1 has been launched on September 19th as the main product of [LegatoSwap](https://app.lambodoge.org). 2 staking pools are available, `LDOGE/LDOGE` and `LP-LDOGE-BNB/LDOGE`,
